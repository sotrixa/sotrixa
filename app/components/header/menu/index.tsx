...
const hasHorizontalScrollControls = (
  win: Window,
): win is Window & {
  horizontalScrollControls: { navigateToPanel: (index: number) => void };
} => {
  return (
    ...
    typeof (win.horizontalScrollControls as unknown as Record<string, unknown>)
...
const menu: MenuItem[] = [
  ...
  },
  {
    ...
    sectionId: "case-studies", // Add section ID for direct link
  },
  {
    title: "CONTACT",
...
export default function Menu({ closeMenu }: MenuProps) {
  ...
  const handleNavigation = (item: MenuItem) => {
    ...
    setTimeout(() => {
      ...
      if (
        hasHorizontalScrollControls(window) &&
    ...
    >
      ...
      >
        <div className="flex gap-4">
          ...
          <a
            href="https://www.linkedin.com/sotrixa"
            target="_blank"
            rel="noopener noreferrer"
            className="uppercase"
          >
