				...
				<div className='container mx-auto'>
					<div className='flex justify-between items-center flex-wrap'>
						...
						<div className='flex space-x-4'>
							<a href='https://www.instagram.com/sotrixa' target='_blank' rel='noopener noreferrer' className='hover:text-teal-400 transition-colors' aria-label='Instagram'>
							...
							<a href='https://www.linkedin.com/company/sotrixa' target='_blank' rel='noopener noreferrer' className='hover:text-teal-400 transition-colors' aria-label='LinkedIn'>
