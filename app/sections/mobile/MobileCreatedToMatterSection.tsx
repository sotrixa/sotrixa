...
export default function MobileCreatedToMatterSection() {
	...
	return (
		<section id='mobile-created-to-matter' className='bg-[#FAFAFA] text-black relative overflow-hidden min-h-screen py-16 px-4'>
			...
			<div className='relative z-10 w-full'>
				...
				<div ref={contentRef} className='space-y-8'>
					...
					<div ref={titleRef} className='text-left mb-8'>
						...
						<div className='h-1 w-24 bg-gradient-to-r from-[#f4dd65] via-[#d142e2] to-[#70DFC6] rounded-full mt-4'></div>
					</div>
