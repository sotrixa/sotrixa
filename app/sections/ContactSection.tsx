				...
				<motion.div className='bg-gray-700 rounded-xl p-8' initial={{ x: 50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.8, delay: 0.2 }}>
					<form className='space-y-4'>
						<div>
							...
							<input type='text' id='name' className='w-full px-4 py-3 bg-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none' placeholder='John Doe' />
						</div>
						<div>
							<label htmlFor='email' className='block mb-2 text-sm font-medium'>
								Your Email
							</label>
							<input type='email' id='email' className='w-full px-4 py-3 bg-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none' placeholder='john@example.com' />
						</div>
						<div>
							<label htmlFor='message' className='block mb-2 text-sm font-medium'>
								Your Message
							</label>
							<textarea id='message' rows={4} className='w-full px-4 py-3 bg-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none' placeholder='How can we help you?'></textarea>
						</div>
