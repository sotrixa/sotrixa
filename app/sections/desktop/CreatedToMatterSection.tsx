        ...
        <div className="w-full px-8 max-[1200px]:px-2 max-[900px]:px-2 max-md:px-4 max-[480px]:px-2">
          ...
          >
            ...
            <div className="flex flex-col">
              {/* Title section */}
              <div ref={titleRef} className="text-left mb-8">
                <h1
                  className="font-bold m-0"
                  style={{
                    fontSize: "clamp(0.9rem, 4vw, 4.5rem)",
                    lineHeight: 1,
                  }}
                >
              ...
              <motion.div
                className="text-base sm:text-lg leading-relaxed space-y-6"
            ...
            {/* Right column */}
            <motion.div
              className="text-base sm:text-lg leading-relaxed space-y-6 lg:self-start"
              style={{ marginTop: "clamp(5rem, 8vw, 10rem)" }}
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
